...
const styles = StyleSheet.create({ container:{ flex:1, backgroundColor:'#A890F5', alignItems: 'center', justifyContent: 'center' }, 
...
loginBox:{ width: 300, height: 40, borderBottomWidth: 1.5, borderColor : '#ff8a65', fontSize: 20, margin:10, paddingLeft:10 },
 KeyboardAvoidingView:{ flex:1, justifyContent:'center', alignItems:'center' }, modalTitle :{ justifyContent:'center', alignSelf:'center', fontSize:30, color:'#ff5722', margin:50 }
,
